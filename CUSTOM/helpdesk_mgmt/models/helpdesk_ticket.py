...
class HelpdeskTicket(models.Model):
    ...
    handel_id = fields.Selection(
            selection=[
            ("PT Clarus Innovace Teknologi", "PT Clarus Innovace Teknologi"),
            ("PT Cahaya Innovasi Telematika", "PT Cahaya Innovasi Telematika"),
    ...
    pm = fields.Selection(
            selection=[
            ("Findia", "Findia Nurrahman"),
            ("Bara", "Bara Deva"),
            ("David", "David"),
            ("Renny Amalia", "Renny Amalia"),
